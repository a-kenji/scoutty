...
Terminal multiplexers (tmux, screen, zellij) filter capabilities, SSH forwarding adds another layer of indirection, and nested sessions compound the problem. No static database can account for what actually reaches you in a given session.
